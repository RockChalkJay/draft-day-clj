...
;; :fgm_yds, :pass_int_td, :pr_td, :def_kr_td, :pts_allow_0 and
...
(def ^:private stat-keys
  [:pass_yd :pass_td :pass_int :pass_2pt
   ...
   :fum_lost
   :fgm :xpm
   ;; The two lines publish different buckets, so both sets are carried and each
   ;; line scores what it has. See `summed-fgm`.
